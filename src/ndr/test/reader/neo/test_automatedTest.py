# Port of +ndr/+test/+reader/+neo/automatedTest.m
"""Automated tests for the Neo reader.

This test covers Neo reader functionality with Blackrock (.nev, .ns2) and Intan
(.rhd) file formats, including reading markers, events, analog data, and
channel epoch information.

NOTE: These tests require a fully implemented Neo reader and example data files
in the NDR example_data directory. Most tests are marked xfail because the Neo
reader is not yet fully implemented.
"""
